...
gerente = Gerente("Ana", "TEC001", 8000, 2000)
desenvolvedor = Desenvolvedor("Carlos", "TEC002", 6000, "Senior")

gerente.__salario_base = -100
print(f"Salario base protegido do gerente: R$ {gerente.get_salario_base():.2f}")
